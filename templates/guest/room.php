<?php
function czyZajete($r, $j, $seance, $room)
{
    $db = DataBase::getDB();
    ...
    <div class="rows">
        <form action="" method="POST">
            ...
            if (isset($_POST['date']) && !empty($_POST['date'])) {
                ...
                $zap = $db->prepare("SELECT showing_to_date FROM movie_showing WHERE movie_id = (SELECT `movie_showing_id` from seance where id = 3) ");
