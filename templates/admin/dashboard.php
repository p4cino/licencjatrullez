<div class="jumbotron jumbotron-fluid bg-inverse" id="bg1">
	<div class="container">
		<h1 class="display-3">Witaj <?php echo $User->getName(); ?>.</h1>
		<p class="lead">W tym panelu masz dostęp do wszystkiego.</p>
		<br />
	</div>
</div>
...
<div class ="container">
	...
	$User->setImie($_POST['inputName']);
	$User->setNazwisko($_POST['inputSurname']);
	$User->setTelefon($_POST['inputPhone']);
		...
		<form role="form" method="POST">
			<div class="form-group">
				...
				<div class="input-group Name">
					...
					<input type="text" value="<?php echo $User->getName(); ?>" class="form-control" name="inputName" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="input-group Name">
					...
					<input type="text" value="<?php echo $User->getSurname(); ?>" class="form-control" name="inputSurname" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="input-group phone">
					...
					<input type="phone" value="<?php echo $User->getTelephone(); ?>" class="form-control" name="inputPhone" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="input-group email">
					...
					<input type="email" value="<?php echo $User->getEmail(); ?>" class="form-control" name="inputEmail" required>
				</div>
			</div>
